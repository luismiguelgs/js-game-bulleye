window.addEventListener('load',function(){
    ...
    class Spark extends Particle{
        update(){
            ...
            this.collisionY -= Math.cos(this.angle);
    ...
    class Player{
        ...
        update(){
            ...
            if(angle < -2.74 || angle > 2.47) this.frameY = 6;
    ...
    class Game{
        ...
        render(context, deltaTime){
            if(this.timer > this.interval){
                ...
                this.gameObjects = [...this.eggs,
                     ...this.obstacles, this.player, ...this.enemies, ...this.hatchlings,
                        ...this.praticles];
            ...
            if(this.score >= this.winningScore){
                ...
                context.fillText(`Final Score: ${this.lostHatchlings}. Press 'R' to butt heads again`, this.width *0.5, this.height *0.5 + 80);
                context.restore();
            }
        }
        checkCollision(a,b){
        ...
        removeGameObject(){
            ...
            this.praticles= this.praticles.filter(object=>!object.markedForDeletion);
        }
        restart(){
            this.player.restart();
            this.obstacles = []
        ...
        init(){
            ...
            while (this.obstacles.length < this.numberOfObstacles && attemps < 500){
                ...
                this.obstacles.forEach(obstacle => {
                    ...
                    const distance = Math.hypot(dy,dx);
                    const distaceBuffer = 100;
                    const sumOfRadi = testObstacle.collisionRadius + obstacle.collisionRadius + distaceBuffer; 
